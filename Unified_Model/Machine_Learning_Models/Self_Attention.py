...
class Self_Attention(nn.Module):
    def __init__(self, input_size, hidden_size,output_size, n_encoder = 1, heads = 1, dropout = 0.3):
        super().__init__()
        self.encoder = Encoder( input_size,hidden_size, n_encoder, heads, dropout)
...
class Encoder(nn.Module):
    def __init__(self, input_size,hidden_size, n_encoder, heads, dropout):
        super().__init__()
        self.n_encoder = n_encoder
        self.layers = get_clones(EncoderLayer(input_size, heads, hidden_size, dropout), n_encoder)
